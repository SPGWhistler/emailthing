...
try {	
	...
	$DataExtensionNameForTesting = "DE_Survey_Data";
	...
	$patchDRRow->props = array("rID" => $rid, "CompleteDate" => date('m/d/Y H:i:s'), "Complete" => "TRUE");
	...
	*/
	...
	$getDERows->props = array("Email", "JobID", "sID", "rID", "SendDate", "CompleteDate", "Complete", "EmailName", "SubscriberId");
	//$dataextensionrow->filter = array('Property' => 'rID', 'SimpleOperator' => 'equals', 'Value' => '004cdd91e828c3a98c6dbeaa8eb816a1');
